...
public class RentalService extends BaseService<Long, Rental> {
    ...
    public RentalService(ClientService clientService, MovieService movieService, IRepository<Long, Rental> repository, Validator<Rental> validator) {
    ...
    @Override
    public void addEntity(Rental entity) throws ValidatorException {
